...
import { ArrowLeft, FileUp, MessageSquarePlus, Paperclip } from "lucide-react";
...
export default function CustomerDetail() {
  ...
  const { customer, interactions, documents, contracts, opportunities, reservations } = detail.data;
