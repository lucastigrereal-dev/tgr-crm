...
export default function Reservations() {
  ...
  const waitlist = trpc.operations.waitlist.useQuery();
  const utils = trpc.useUtils();
  ...
  const bookingByUnitDay = useMemo(() => {
    const index = new Map<string, NonNullable<typeof reservations.data>[number]>();
