...
const allowedPayloadFields: Record<DomainEventName, readonly string[]> = {
  ...
  "sales.intake.received": ["saleId", "sourceEventId", "crmCustomerId", "project"], "sales.intake.linked": ["saleId", "crmCustomerId", "crmContractId", "project"], "relationship.delivery.pending": ["externalEventId"],
