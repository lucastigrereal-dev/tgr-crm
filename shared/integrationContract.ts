...
const allowedPayloadFields: Record<DomainEventName, readonly string[]> = {
  ...
  "contract.created": ["customerId", "status", "usageModel"], "contract.status.updated": ["status"], "contract.cancellation.requested": ["contractId", "paidAmount"], "contract.cancellation.decided": ["decision"], "contract.cancellation.executed": ["contractId", "cancelledInstallments", "cancelledCommissions", "financialEntries"], "contract.document.uploaded": ["contractId", "category", "filename"], "contract.document.signed": ["contractId"],
