...
const allowedPayloadFields: Record<DomainEventName, readonly string[]> = {
  ...
  "contract.created": ["customerId", "status", "usageModel"], "contract.status.updated": ["status"], "contract.cancellation.requested": ["contractId", "paidAmount"], "contract.cancellation.decided": ["decision"], "contract.cancellation.executed": ["contractId", "cancelledInstallments", "cancelledCommissions", "financialEntries"], "contract.document.uploaded": ["contractId", "category", "filename"], "contract.document.signed": ["contractId"], "contract.monetary_adjustment.applied": ["adjustmentId", "contractId", "policyVersionId", "policyVersion", "baseDate", "throughDate", "indexCode", "totalFactor", "beforeTotal", "afterTotal"],
  ...
  "opportunity.created": ["customerId", "sellerId", "stage", "expectedAmount", "campaignId"], "opportunity.updated": ["sellerId", "stage", "previousStage", "expectedAmount", "campaignId"], "proposal.created": ["opportunityId", "status", "totalAmount", "saleTruthStage"], "proposal.accepted": ["opportunityId", "status", "totalAmount", "saleTruthStage"], "proposal.discount.requested": ["proposalId", "requestedAmount", "discountPercent"], "proposal.discount.decided": ["proposalId", "status", "approvedAmount"], "sales.playbook.created": ["stage", "title"],
  ...
  "installment.renegotiation.proposed": ["installmentId", "proposalAmount"], "installment.paid": ["installmentId", "paidAmount", "contractId", "sequence", "amount", "source", "gatewayPaymentId", "commissionBlocked"], "commission.created": ["sellerId", "campaignId", "opportunityId", "contractId", "sourceInstallmentId", "commissionRole", "amount", "rate"], "commission.status.updated": ["status", "contractId"], "commission.automatic.blocked": ["contractId", "reason", "source"], "revenue_quality_ledger.synced": ["factCount", "policyVersion"], "financial.portfolio.assigned": ["contractId", "ownerUserId"], "financial.entry.created": ["type", "category", "amount", "contractId", "campaignId"], "financial.billing.created": ["installmentId", "gatewayProvider", "gatewayPaymentId", "type"], "financial.entry.reconciled": ["reference", "reconciledAt"], "financial.transfer.created": ["amount", "recipient", "contractId"], "financial.transfer.paid": ["amount", "contractId"], "ai.assistance.requested": ["role", "evidenceCount", "model"],
  "sales.command.sale.ingested": ["customerId", "saleId", "encounterId", "projectExternalKey", "projectName", "projectTimezone", "correlationId", "quotasCount", "vgvCents", "entryContractedCents", "entryReceivedCents", "entryInstallmentCount", "firstBalanceDueInDays", "paymentMethods"],
  "commercial.inventory.bootstrapped": ["resortId", "units", "fractionsPerUnit", "createdFractions"],
  "commercial.fraction.status.changed": ["fractionId", "status", "proposalId", "contractId", "holdId", "expiresAt", "reason"],
};
