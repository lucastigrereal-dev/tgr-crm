...
const allowedPayloadFields: Record<DomainEventName, readonly string[]> = {
  ...
  "opportunity.created": ["customerId", "sellerId", "stage", "expectedAmount", "campaignId"], "opportunity.updated": ["sellerId", "stage", "previousStage", "expectedAmount", "campaignId"], "proposal.created": ["opportunityId", "status", "totalAmount", "saleTruthStage"], "proposal.accepted": ["opportunityId", "status", "totalAmount", "saleTruthStage"], "sales.playbook.created": ["stage", "title"],
