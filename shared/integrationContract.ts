...
const allowedPayloadFields: Record<DomainEventName, readonly string[]> = {
  ...
  "installment.renegotiation.proposed": ["installmentId", "proposalAmount"], "installment.paid": ["installmentId", "paidAmount"], "financial.entry.created": ["type", "amount", "campaignId"], "financial.entry.reconciled": ["reference", "reconciledAt"], "financial.transfer.created": ["amount", "recipient"],
};
