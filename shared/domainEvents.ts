export const domainEventCatalog = {
  ...
  "sales.intake.received": { aggregateType: "external_sale", description: "Venda confirmada recebida do TGR Sales Command para formalização no CRM." },
  "sales.intake.linked": { aggregateType: "contract", description: "Venda canônica do Sales Command vinculada ao cliente e contrato do CRM." },
  "relationship.delivery.pending": { aggregateType: "contract", description: "Evento de ciclo contratual aguardando entrega ao TGR Relationship." },
