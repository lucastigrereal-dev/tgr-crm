...
export type CommercialIntegrityInput = {
  commissions: Array<{ id: number; contractId: number; amount: number; status: "pending" | "approved" | "paid" | "cancelled"; sourceInstallmentId?: number | null; sourceInstallmentStatus?: "open" | "paid" | "overdue" | "cancelled" | "renegotiated" | null }>;
