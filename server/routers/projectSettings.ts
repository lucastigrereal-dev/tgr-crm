...
const settingsInput = z.object({ resortId: z.number().int().positive(), cancellationPolicy: z.string().max(20_000).optional().nullable(), requiredCaptureFields: z.string().max(20_000).optional().nullable(), requiredContractDocuments: z.string().max(20_000).optional().nullable(), commercialRoles: z.string().max(20_000).optional().nullable(), commissionPolicy: z.string().max(20_000).optional().nullable() });
