...
import { z } from "zod";
import { billingRecords, captureRecords, contracts, customers, financialTransactions, financialTransfers, installmentRenegotiations, installments, opportunities, proposals, salesCampaigns, salesCommissions } from "../../drizzle/schema";
